      ...
      <nav id="nav">
        <article class="container top padding">
          ...
          <section class="icons">
            ...
            <a href="<?php echo esc_url( get_permalink( get_page_by_title( 'Mi cuenta' ) ) ); ?>"><svg width="16px" height="18px" viewBox="0 0 16 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
